...
srun python saliency_masking_strategy.py \
    ...
    --mel_band_frac 0.5 \
    --output_name "saliency_maps_gaussian_time_mel" \
    --mask_name "time_mel_gaussian_masks"

srun python evaluate_insertion_deletion.py \
        --images   ESC50_spectrograms \
        --maps_dir saliency/saliency_maps_gaussian_time_mel \
        --suffix   _saliency.npy \
        --output_dir evaluations/evaluation_RISE_gaussian_time_mel