#!/bin/bash
#SBATCH --job-name=eval_batch_5
#SBATCH --cpus-per-task=2
#SBATCH --gres=gpu:1080:1
#SBATCH --mem=10000M
#SBATCH --time=6-00:00:00
#SBATCH --output=logs/eval_batch_5_%j.out
#SBATCH --error=logs/eval_batch_5_%j.err

# Load modules (uncomment if needed)
#module load anaconda/3-5.0.1
#module load cuda/11.1

echo "=== Starting Evaluation Batch 5 ==="
echo "Node: $(hostname)"
...
run_evaluation "freq" "none"
run_evaluation "rect" "none"
run_evaluation "mel" "none"
