...
srun python src/evaluation_scripts/evaluate_insertion_deletion_waveform.py \
        --audio test_audio \
        --maps_dir results/saliency/saliency_RISE_waveform_combined_occlusion_zeros \
        --suffix _rise_waveform.npy \
        --output_dir results/evaluations/evaluation_RISE_waveform_combined_occlusion_zeros
