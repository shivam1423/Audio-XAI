...
srun python -u src/evaluation_scripts/evaluate_insertion_deletion_waveform.py \
    ...
    --maps_dir results/saliency/saliency_RISE_waveform_combined_discrete_occlusion_gaussian \
    --suffix _rise_waveform.npy \
    --output_dir results/evaluations/evaluation_RISE_waveform_combined_discrete_occlusion_gaussian
