...
# -----------------------------------------------------------------------------
#  This module is an UNMODIFIED copy of `RISE_original/explanations.py`.
#  It works for both RGB images and the spectrogram "images" produced in the
#  new audio pipeline because the mask-application logic is channel-agnostic.
# -----------------------------------------------------------------------------
