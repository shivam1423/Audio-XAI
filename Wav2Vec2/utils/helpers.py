"""
Utility functions for Wav2Vec2 ESC-50 project
"""
import os
import torch
import numpy as np
...
def download_esc50(data_dir: str = "data/ESC-50") -> str:
    """
    ...
    if os.path.exists(data_dir):
        print(f"ESC-50 dataset already exists at {data_dir}")
        return data_dir
    ...
    extracted_dir = os.path.join(data_dir, "ESC-50-master")
    ...
    print(f"ESC-50 dataset downloaded and extracted to {data_dir}")
    return data_dir
