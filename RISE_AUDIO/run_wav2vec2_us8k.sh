...
if [ "$DATASET" = "urbansound8k" ]; then
    ...
    DEFAULT_OUTPUT_DIR="results/saliency/wav2vec2/UrbanSound8K_fold10_48khz_all_multiple_6000masks_discrete"
else
    DEFAULT_INPUT_DIR='../ESC50/audio'
    DEFAULT_OUTPUT_DIR="results/saliency/wav2vec2/ESC50_48khz_all_multiple_6000masks_discrete"
fi
