...
if [ "$DATASET" = "urbansound8k" ]; then
    DEFAULT_INPUT_DIR='../UrbanSound8K/audio/fold10'
    DEFAULT_OUTPUT_DIR="results/saliency/htsat/UrbanSound8K_fold10_48khz_all_multiple_6000masks_discrete"
else
    DEFAULT_INPUT_DIR='../ESC50/audio'
    DEFAULT_OUTPUT_DIR="results/saliency/htsat/ESC50_48khz_all_multiple_6000masks_discrete"
fi
...
echo ""
echo "======================================"
echo "✓ HTSAT processing complete!"
echo "======================================"
